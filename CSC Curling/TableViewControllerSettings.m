...
{
    static NSString *CellIdentifier=@"TableCellSett";
    TableCellSett           *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
